...
#define TEST_BASE_SEED_STR "common_20000"   // Mnemonic generation for traing and testing
// #define TEST_BASE_SEED_STR "a_20000"
// #define TEST_BASE_SEED_STR "b_20000"
// #define TEST_BASE_SEED_STR "c_20000"
// #define TEST_BASE_SEED_STR "d_20000"
...
// idx → 32-byte entropy (ENT=256bit)
...
const uint8_t *config_getSeed(void) {
  ...
  if (config_getMnemonic(mnemonic, sizeof(mnemonic))) {
    ...
    // ------------------------------------------------------------------
    // ## On-the-fly 20,000 mnemonic generation 
    // ------------------------------------------------------------------
